...
import { Plan, ChartData, Contact, ExportHistory, Order } from '../types';
...
export const MOCK_CONTACTS: Contact[] = [
  ...
  { id: 2, name: 'Jane Smith', email: 'jane.s@example.com', company: 'Innovate LLC', phone: '234-567-8901', status: 'Lead', avatarUrl: 'https://picsum.photos/seed/2/40/40', title: 'Marketing Manager', city: 'New York', state: 'NY', country: 'USA', website: 'https://innovate.com', personLinkedinUrl: 'https://linkedin.com/in/janesmith', tags: 'marketing,b2b', notes: 'Interested in our analytics tools. Scheduled a demo for next week.' },
  { id: 3, name: 'Sam Wilson', email: 'sam.w@example.com', company: 'Tech Solutions', phone: '345-678-9012', status: 'Customer', avatarUrl: 'https://picsum.photos/seed/3/40/40', title: 'CTO', city: 'Austin', state: 'TX', country: 'USA', website: 'https://techsolutions.io', personLinkedinUrl: 'https://linkedin.com/in/samwilson', tags: 'dev,api,cto', notes: 'Long-time customer, very satisfied with the service.' },
