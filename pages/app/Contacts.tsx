...
const Contacts: React.FC = () => {
  ...
  useEffect(() => {
    const fetchContacts = async () => {
      if (!user) return;
      setIsLoading(true);
      // Fetch only the contacts that belong to the currently logged-in user.
      ...
      if (error) {
        ...
        // Map database snake_case columns to camelCase component props.
  ...
  const filteredContacts = useMemo(() => {
    // Check if contact properties exist before calling toLowerCase() to prevent runtime errors.
